...
namespace MezeoFileShellExt
{
  ...
  //  [Guid("23666051-8DE9-4EC4-A692-B6ADA8110ACB")]
  ...
  //  [Guid("56703D0A-550D-4CDB-AEC4-F68D42B3B72B")]
    ...
    internal class ShellExtReg
    {
            ...
            string fileType, string friendlyName)
        {
            ...
            string keyName1 = string.Format(@"Directory\shellEx\ContextMenuHandlers\{0}",
                friendlyName);
            ...
            string fileType, string friendlyName)
        {
            ...
            string keyName = string.Format(@"{0}\shellex\ContextMenuHandlers\{1}",
                fileType, friendlyName);
          //  string keyName = string.Format(@"\AllFilesystemObjects\shellex\ ContextMenuHandlers\{0}", clsid.ToString("B"));
